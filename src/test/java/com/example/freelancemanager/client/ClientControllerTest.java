...
public class ClientControllerTest {
        ...
        @Test
        void delete_Projectが存在するClientの場合409Conflictを返す() throws Exception {
                doThrow(new ConflictException("client has projects. id=1"))
                                .when(clientService)
                                .delete(1L);
                ...
                mockMvc.perform(delete("/api/clients/1"))
                                ...
                                .andExpect(jsonPath("$.message").value("client has projects. id=1"))
